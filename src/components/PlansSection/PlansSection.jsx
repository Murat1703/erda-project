...
//     //         if (
//     //             filtersSection.businessCenter !== "Все бизнес-центры"
//     //         ) {
//     //             if (item.businessCenter !== filtersSection.businessCenter.toLowerCase()){return false} 
//     //         }
//     //         if (
//     //             filtersSection.businessCenter == "Все бизнес-центры"
//     //         ) {
//     //             if (item.businessCenter !== filtersSection.businessCenter.toLowerCase()){return true} 
//     //         }
...
export const PlansSection = () => {
  ...
  const propertyFilters  = [
    { label: "Все",       value: "all" },
    { label: "Коммерция", value: "commercy" },
    { label: "Офисы",     value: "offices" },
  ];

  const dealFilters = [
    { label: "Все",    value: 'all' },
    { label: "Покупка", value: 'sale' },
    { label: "Аренда",  value: 'rent' },
  ];

  const businessCenterFilter = [
    { key: "Все бизнес-центры", value: "Все бизнес-центры" },
    { key: "Icon",              value: "Icon" },
    { key: "Luminor",           value: "Luminor" },
    { key: "Norex",             value: "Norex" },
  ];
  ...
  }, [businessCenter, propertyType, dealType, minSquare, maxSquare]);
            ...
            <div className={cls.filter}>
              ...
              <div>
                ...
                <input 
                  ...
                  step={0.1}
                  value={minSquare}
                  onChange={(e) => setMinSquare(Number(e.target.value))}
                />
                <input 
                  type="range" 
                  name="max"
                  ...
                  step={0.1}
                  value={maxSquare}
                  onChange={(e) => setMaxSquare(Number(e.target.value))}
                />
                <span></span>
              </div>
            </div>
