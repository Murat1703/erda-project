            ...
            <section className={cls.consultationWrapper}>
                <div className={cls.consultationInnner}>
                    <div className={cls.left}>
                        ...
                        <p> Станьте частью эксклюзивного бизнес-сообщества.<br/> Ваш личный менеджер подготовит индивидуальные условия. найдем идеальный офис, подчеркивающий уровень вашего бизнеса. </p>
                    </div>
                    {isSend? null : 
                        <form className={cls.right} onSubmit={(e)=>handleSubmit(e)}>
                            ...
                            <div className={cls.bottom}>
                                ...
                                <button type='submit' onClick={(e)=>handleSubmit(e)}>Оставить заявку</button>
                            </div>
                        </form>
                    }
                    {isSend? 
