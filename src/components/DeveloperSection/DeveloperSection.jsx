            ...
            <div className={cls.developerSectionInner}>
                <div className={cls.top}>
                    ...
                    <div className={cls.developerInfo}>
                        <p>
                            ERDA Holding — новый девелопер на рынке коммерческой недвижимости.
                        </p>
                        <p>
                            Три бизнес-центра компании формируют целостный образ бренда и демонстрируют современный подход к строительству, технологиям и качеству девелопмента.
                        </p>
                        <p>
                            Станьте частью эксклюзивного бизнес-сообщества. Ваш личный менеджер подготовит индивидуальные условия. найдем идеальный офис, подчеркивающий уровень вашего бизнеса.
                        </p>
